...
import 'package:zenan/features/home/controllers/advertisement_controller.dart';
import 'package:zenan/features/home/domain/repositories/advertisement_repository.dart';
import 'package:zenan/features/home/domain/repositories/advertisement_repository_interface.dart';
import 'package:zenan/features/home/domain/services/advertisement_service.dart';
import 'package:zenan/features/home/domain/services/advertisement_service_interface.dart';
import 'package:zenan/features/product/controllers/campaign_controller.dart';
import 'package:zenan/features/cart/controllers/cart_controller.dart';
import 'package:zenan/features/cart/domain/repositories/cart_repository.dart';
import 'package:zenan/features/cart/domain/repositories/cart_repository_interface.dart';
import 'package:zenan/features/cart/domain/services/cart_service.dart';
import 'package:zenan/features/cart/domain/services/cart_service_interface.dart';
import 'package:zenan/features/chat/controllers/chat_controller.dart';
import 'package:zenan/features/chat/domain/repositories/chat_repository.dart';
import 'package:zenan/features/chat/domain/repositories/chat_repository_interface.dart';
import 'package:zenan/features/chat/domain/services/chat_service.dart';
import 'package:zenan/features/chat/domain/services/chat_service_interface.dart';
import 'package:zenan/features/checkout/controllers/checkout_controller.dart';
import 'package:zenan/features/checkout/domain/repositories/checkout_repository.dart';
import 'package:zenan/features/checkout/domain/repositories/checkout_repository_interface.dart';
import 'package:zenan/features/checkout/domain/services/checkout_service.dart';
import 'package:zenan/features/checkout/domain/services/checkout_service_interface.dart';
import 'package:zenan/features/coupon/controllers/coupon_controller.dart';
import 'package:zenan/features/home/controllers/home_controller.dart';
import 'package:zenan/features/home/domain/repositories/home_repository.dart';
import 'package:zenan/features/home/domain/repositories/home_repository_interface.dart';
import 'package:zenan/features/home/domain/services/home_service.dart';
import 'package:zenan/features/home/domain/services/home_service_interface.dart';
...
import 'package:zenan/features/order/domain/repositories/order_repository.dart';
import 'package:zenan/features/order/domain/repositories/order_repository_interface.dart';
import 'package:zenan/features/order/domain/services/order_service.dart';
import 'package:zenan/features/order/domain/services/order_service_interface.dart';
import 'package:zenan/features/product/domain/repositories/campaign_repository.dart';
import 'package:zenan/features/product/domain/repositories/campaign_repository_interface.dart';
import 'package:zenan/features/product/domain/services/campaign_service.dart';
import 'package:zenan/features/product/domain/services/campaign_service_interface.dart';
import 'package:zenan/features/restaurant/controllers/restaurant_controller.dart';
import 'package:zenan/features/html/controllers/html_controller.dart';
import 'package:zenan/features/html/domain/repositories/html_repository.dart';
import 'package:zenan/features/html/domain/repositories/html_repository_interface.dart';
import 'package:zenan/features/html/domain/services/html_service.dart';
import 'package:zenan/features/html/domain/services/html_service_interface.dart';
import 'package:zenan/features/language/domain/models/language_model.dart';
import 'package:zenan/features/language/domain/repository/language_repository.dart';
import 'package:zenan/features/language/domain/repository/language_repository_interface.dart';
import 'package:zenan/features/language/domain/service/language_service.dart';
import 'package:zenan/features/language/domain/service/language_service_interface.dart';
import 'package:zenan/features/notification/controllers/notification_controller.dart';
import 'package:zenan/features/notification/domain/repository/notification_repository.dart';
import 'package:zenan/features/notification/domain/repository/notification_repository_interface.dart';
import 'package:zenan/features/notification/domain/service/notification_service.dart';
import 'package:zenan/features/notification/domain/service/notification_service_interface.dart';
import 'package:zenan/features/onboard/controllers/onboard_controller.dart';
import 'package:zenan/features/onboard/domain/repository/onboard_repository.dart';
import 'package:zenan/features/onboard/domain/repository/onboard_repository_interface.dart';
import 'package:zenan/features/onboard/domain/service/notification_service.dart';
...
import 'package:zenan/features/profile/domain/repositories/profile_repository.dart';
import 'package:zenan/features/profile/domain/repositories/profile_repository_interface.dart';
import 'package:zenan/features/profile/domain/services/profile_service.dart';
import 'package:zenan/features/profile/domain/services/profile_service_interface.dart';
import 'package:zenan/features/refer%20and%20earn/controllers/refer_and_earn_controller.dart';
import 'package:zenan/features/restaurant/domain/repositories/restaurant_repository.dart';
import 'package:zenan/features/restaurant/domain/repositories/restaurant_repository_interface.dart';
import 'package:zenan/features/restaurant/domain/services/restaurant_service.dart';
import 'package:zenan/features/restaurant/domain/services/restaurant_service_interface.dart';
import 'package:zenan/features/search/controllers/search_controller.dart';
import 'package:zenan/features/search/domain/repositories/search_repository.dart';
import 'package:zenan/features/search/domain/repositories/search_repository_interface.dart';
import 'package:zenan/features/search/domain/services/search_service.dart';
import 'package:zenan/features/search/domain/services/search_service_interface.dart';
...
import 'package:zenan/features/address/controllers/address_controller.dart';
import 'package:zenan/features/address/domain/reposotories/address_repo.dart';
import 'package:zenan/features/address/domain/reposotories/address_repo_interface.dart';
import 'package:zenan/features/address/domain/services/address_service.dart';
import 'package:zenan/features/address/domain/services/address_service_interface.dart';
import 'package:zenan/features/auth/controllers/deliveryman_registration_controller.dart';
import 'package:zenan/features/auth/controllers/restaurant_registration_controller.dart';
import 'package:zenan/features/auth/domain/reposotories/auth_repo.dart';
import 'package:zenan/features/auth/domain/reposotories/auth_repo_interface.dart';
import 'package:zenan/features/auth/domain/reposotories/deliveryman_registration_repo.dart';
import 'package:zenan/features/auth/domain/reposotories/deliveryman_registration_repo_interface.dart';
import 'package:zenan/features/auth/domain/reposotories/restaurant_registration_repo.dart';
import 'package:zenan/features/auth/domain/reposotories/restaurant_registration_repo_interface.dart';
import 'package:zenan/features/auth/domain/services/auth_service.dart';
import 'package:zenan/features/auth/domain/services/auth_service_interface.dart';
import 'package:zenan/features/auth/domain/services/deliveryman_registration_service.dart';
import 'package:zenan/features/auth/domain/services/deliveryman_registration_service_interface.dart';
import 'package:zenan/features/auth/domain/services/restaurant_registration_service.dart';
import 'package:zenan/features/auth/domain/services/restaurant_registration_service_interface.dart';
import 'package:zenan/features/business/controllers/business_controller.dart';
import 'package:zenan/features/business/domain/reposotories/business_repo.dart';
import 'package:zenan/features/business/domain/reposotories/business_repo_interface.dart';
...
import 'package:zenan/features/coupon/domain/reposotories/coupon_repository.dart';
import 'package:zenan/features/coupon/domain/reposotories/coupon_repository_interface.dart';
import 'package:zenan/features/coupon/domain/services/coupon_service.dart';
import 'package:zenan/features/coupon/domain/services/coupon_service_interface.dart';
import 'package:zenan/features/cuisine/controllers/cuisine_controller.dart';
import 'package:zenan/features/cuisine/domain/repositories/cuisine_repository.dart';
import 'package:zenan/features/cuisine/domain/repositories/cuisine_repository_interface.dart';
import 'package:zenan/features/cuisine/domain/services/cuisine_service.dart';
import 'package:zenan/features/cuisine/domain/services/cuisine_service_interface.dart';
import 'package:zenan/features/dashboard/controllers/dashboard_controller.dart';
import 'package:zenan/features/dashboard/domain/services/dashboard_service.dart';
import 'package:zenan/features/dashboard/domain/services/dashboard_service_interface.dart';
import 'package:zenan/features/favourite/controllers/favourite_controller.dart';
import 'package:zenan/features/favourite/domain/repositories/favourite_repository.dart';
import 'package:zenan/features/favourite/domain/repositories/favourite_repository_interface.dart';
import 'package:zenan/features/favourite/domain/services/favourite_service.dart';
import 'package:zenan/features/favourite/domain/services/favourite_service_interface.dart';
import 'package:zenan/features/interest/controllers/interest_controller.dart';
import 'package:zenan/features/interest/domain/repositories/interest_repository.dart';
import 'package:zenan/features/interest/domain/repositories/interest_repository_interface.dart';
import 'package:zenan/features/interest/domain/services/interest_service.dart';
import 'package:zenan/features/interest/domain/services/interest_service_interface.dart';
import 'package:zenan/features/location/controllers/location_controller.dart';
import 'package:zenan/features/location/domain/reposotories/location_repo.dart';
import 'package:zenan/features/location/domain/reposotories/location_repo_interface.dart';
import 'package:zenan/features/location/domain/services/location_service.dart';
import 'package:zenan/features/location/domain/services/location_service_interface.dart';
import 'package:zenan/features/loyalty/controllers/loyalty_controller.dart';
import 'package:zenan/features/loyalty/domain/repositories/loyalty_repository.dart';
import 'package:zenan/features/loyalty/domain/repositories/loyalty_repository_interface.dart';
import 'package:zenan/features/loyalty/domain/services/loyalty_service.dart';
import 'package:zenan/features/loyalty/domain/services/loyalty_service_interface.dart';
import 'package:zenan/features/product/controllers/product_controller.dart';
import 'package:zenan/features/product/domain/repositories/product_repository.dart';
import 'package:zenan/features/product/domain/repositories/product_repository_interface.dart';
import 'package:zenan/features/product/domain/services/product_service.dart';
import 'package:zenan/features/product/domain/services/product_service_interface.dart';
import 'package:zenan/features/review/controllers/review_controller.dart';
import 'package:zenan/features/review/domain/repositories/review_repository.dart';
import 'package:zenan/features/review/domain/repositories/review_repository_interface.dart';
import 'package:zenan/features/review/domain/services/review_service.dart';
import 'package:zenan/features/review/domain/services/review_service_interface.dart';
import 'package:zenan/features/splash/domain/repositories/splash_repository.dart';
import 'package:zenan/features/splash/domain/repositories/splash_repository_interface.dart';
import 'package:zenan/features/splash/domain/services/splash_service.dart';
import 'package:zenan/features/splash/domain/services/splash_service_interface.dart';
import 'package:zenan/features/verification/controllers/verification_controller.dart';
import 'package:zenan/features/verification/domein/reposotories/verification_repo.dart';
import 'package:zenan/features/verification/domein/reposotories/verification_repo_interface.dart';
import 'package:zenan/features/verification/domein/services/verification_service.dart';
import 'package:zenan/features/verification/domein/services/verification_service_interface.dart';
import 'package:zenan/features/wallet/controllers/wallet_controller.dart';
import 'package:zenan/features/wallet/domain/repositories/wallet_repository.dart';
import 'package:zenan/features/wallet/domain/repositories/wallet_repository_interface.dart';
import 'package:zenan/features/wallet/domain/services/wallet_service.dart';
import 'package:zenan/features/wallet/domain/services/wallet_service_interface.dart';
...
Future<Map<String, Map<String, String>>> init() async {
  ...
  Get.lazyPut(
      () => FasonCategoryController(categoryServiceInterface: Get.find()));

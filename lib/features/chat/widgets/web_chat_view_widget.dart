...
import 'package:zenan/common/widgets/web_search_field_widget.dart';
...
import 'package:zenan/features/chat/widgets/chatting_shimmer_widget.dart';
import 'package:zenan/features/chat/widgets/message_bubble_widget.dart';
import 'package:zenan/features/chat/widgets/web_conversation_list_view_widget.dart';
                      ...
                      children: [
                        ...
                        Expanded(
                          child: Container(
                            ...
                            child: Column(children: [
                              /// Header
                              if (widget.chatController.notificationBody !=
                                  null)
                                Container(
                                  padding: const EdgeInsets.symmetric(
                                              ...
                                              : Center(
                                                  child: Column(
                                                      ...
                                                      const CustomAssetImageWidget(
                                                          ...
                                                          height: 60,
                                                          width: 60),
                                                      Text('no_message_found'
                                                          .tr),
                                                    ]))
                                          : const ChattingShimmerWidget()
                                      : Column(
                                          mainAxisAlignment:
                                                                  ...
                                                                  children: [
                                                                    ...
                                                                    Expanded(
                                                                        child: Column(
                                                                            ...
                                                                            children: [
                                                                          Text(
                                                                            chatController.objWebFile[index].names.first ??
                                                                                'attachment'.tr,
                                                                            maxLines:
                                                                                1,
                                                                            overflow:

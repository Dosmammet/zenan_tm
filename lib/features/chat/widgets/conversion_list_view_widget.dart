...
class ConversationListViewWidget extends StatefulWidget {
  ...
  const ConversationListViewWidget({
    super.key,
  ...
  @override
  State<ConversationListViewWidget> createState() =>
      _ConversationListViewWidgetState();
}

class _ConversationListViewWidgetState
    extends State<ConversationListViewWidget> {
  @override
  void initState() {
    super.initState();
        ...
        ? widget.conversation!.conversations!.isNotEmpty
            ? RefreshIndicator(
                ...
                child: PaginatedListViewWidget(
                  ...
                  enabledPagination:
                      widget.chatController.searchConversationModel == null,
                  productView: ListView.builder(
                    itemCount: widget.conversation?.conversations!.length,
                    physics: const NeverScrollableScrollPhysics(),
                    shrinkWrap: true,
                    ...
                    itemBuilder: (context, index) {
                      ...
                      if (widget.conversation!.conversations![index]!
                        ...
                        user = widget
                            .conversation?.conversations![index]!.receiver;
                        type = widget
                            .conversation?.conversations![index]!.receiverType;
                      } else {
                        user =
                            widget.conversation?.conversations![index]!.sender;
                        type = widget
                        ...
                        child: CustomInkWellWidget(
                            ...
                            if (user != null) {
                              Get.toNamed(RouteHelper.getChatRoute(
                                notificationBody: NotificationBodyModel(
                                  ...
                                  notificationType: NotificationType.message,
                                  adminId:
                                      type == UserType.admin.name ? 0 : null,
                                  restaurantId: type == UserType.vendor.name
                                      ? user.id
                                      : null,
                                  deliverymanId:
                          ...
                          child: Stack(children: [
                            ...
                            Positioned(
                              ...
                              child: Text(
                                DateConverter.localDateToIsoStringAMPM(
                                    DateConverter.dateTimeStringToDate(widget
                                        .conversation!
                                        .conversations![index]!
                                        .lastMessageTime!)),
                                style: robotoRegular.copyWith(
                            ...
                            GetBuilder<ProfileController>(
                              ...
                              return (profileController.userInfoModel != null &&
                                      profileController

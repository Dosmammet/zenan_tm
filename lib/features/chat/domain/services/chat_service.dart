...
class ChatService implements ChatServiceInterface {
  ...
  Future<Response> getMessages(
    ...
    return await chatRepositoryInterface.get(userID.toString(),
        offset: offset, userType: userType, conversationID: conversationID);
  }
  ...
  @override
  List<MultipartBody> processMultipartBody(
  ...
  Future<MessageModel?> sendMessage(
      ...
      List<MultipartDocument>? webVideo) async {
    MessageModel? messageModel;
    if (notificationBody == null || notificationBody.adminId != null) {
      messageModel = await chatRepositoryInterface.sendMessage(
          message, images, 0, UserType.admin, null, webFile, webVideo);

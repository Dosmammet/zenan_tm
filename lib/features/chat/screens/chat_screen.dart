...
import 'package:zenan/features/chat/widgets/conversion_details_shimmer.dart';
                  ...
                  title: Row(children: [
                    ...
                    Column(
                        ...
                        children: [
                          ...
                          (chatController.messageModel != null &&
                                  chatController.messageModel!.conversation!
                                          .receiver!.phone !=
                                      null)
                              ? Text(
                          ...
                          (chatController.messageModel != null &&
                              ...
                              ? Container(
                                  ...
                                  child: Column(children: [
                                    chatController.takeImageLoading &&
                                            !ResponsiveHelper.isDesktop(context)
                                    ...
                                    GetBuilder<ChatController>(
                                      ...
                                      if (chatController.pickedWebVideoFile !=
                                              null &&
                                          ResponsiveHelper.isDesktop(context)) {
                                        return Container(
                                          width: 250,
                                      ...
                                      if (chatController.pickedVideoFile !=
                                          null) {
                                        return Container(
                                          width: 250,
                                          decoration: BoxDecoration(
                                      ...
                                      if (chatController.chatImage.isNotEmpty &&
                                        ...
                                        return SizedBox(
                                          ...
                                          child: ListView.builder(
                                            scrollDirection: Axis.horizontal,
                                            itemCount:
                                                chatController.chatImage.length,
                                            itemBuilder:

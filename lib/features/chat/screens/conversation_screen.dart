...
import 'package:zenan/features/chat/widgets/chat_serach_field_widget.dart';
import 'package:zenan/features/chat/widgets/message_card_widget.dart';
...
import 'package:zenan/features/chat/widgets/web_chat_view_widget.dart';
...
import 'package:zenan/common/enums/user_type.dart';
...
import 'package:zenan/common/widgets/not_logged_in_screen.dart';
import 'package:zenan/common/widgets/paginated_list_view_widget.dart';
...
class _ConversationScreenState extends State<ConversationScreen>
    ...
    return GetBuilder<ChatController>(builder: (chatController) {
      ...
      return Scaffold(
        ...
        floatingActionButton: !ResponsiveHelper.isDesktop(context)
            ? (chatController.conversationModel != null &&
                    chatController.showFloatingButton)
                ? FloatingActionButton(
                    ...
                    child: CustomImageWidget(
                      image:
                          '${Get.find<SplashController>().configModel!.favIconFullUrl}',
                    ),
                  )
                : null
            : null,
                            ...
                            ? RefreshIndicator(
                                ...
                                child: CustomScrollView(
                                    ...
                                    slivers: [
                                      ...
                                      SliverToBoxAdapter(
                                        child: conversation.conversations !=
                                                null
                                            ? conversation
  ...
  Widget conversationCart(
      ChatController chatController, ConversationsModel? conversation) {
            ...
            child: PaginatedListViewWidget(
              ...
              productView: ListView.builder(
                ...
                itemBuilder: (context, index) {
                  User? user;
                  String? type;
                  if (conversation!.conversations![index]!.senderType ==
                          UserType.user.name ||
                      conversation.conversations![index]!.senderType ==
                          UserType.customer.name) {
                  ...
                  String? lastMessage =
                      _lastMessage(conversation.conversations![index]);

                  bool unSeen = (Get.find<ProfileController>().userInfoModel !=
                          null &&
                      Get.find<ProfileController>().userInfoModel!.userInfo !=
                          null &&
                      conversation
                              .conversations![index]!.lastMessage!.senderId !=
                          Get.find<ProfileController>()
                              .userInfoModel!
                              .userInfo
                              ?.id &&
                      conversation.conversations![index]!.unreadMessageCount! >
                          0);

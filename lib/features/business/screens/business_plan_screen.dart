...
import 'package:zenan/features/business/widgets/payment_cart_widget.dart';
...
import 'package:zenan/features/business/domain/models/package_model.dart';
import 'package:zenan/features/business/widgets/base_card_widget.dart';
import 'package:zenan/features/business/widgets/business_payment_method_bottom_sheet_widget.dart';
import 'package:zenan/features/business/widgets/subscription_card_widget.dart';
import 'package:zenan/features/business/widgets/success_widget.dart';
import 'package:zenan/helper/color_coverter.dart';
                                                                    ...
                                                                    return Stack(
                                                                        ...
                                                                        children: [
                                                                          Container(
                                                                            ...
                                                                            margin:
                                                                                const EdgeInsets.only(top: Dimensions.paddingSizeLarge, bottom: Dimensions.paddingSizeExtraSmall),
                                                                            child: SubscriptionCardWidget(
                                                                                index: index,
                                                                                package: package,
                                                                                color: color),
                                                                          ),
                                                                          businessController.activeSubscriptionIndex == index
                                                                              ? Positioned(
                                                                                  top: 5,
                                                                                  right: -10,
                                                                                  child: Container(
                                                  ...
                                                  child: Column(
                                                      ...
                                                      children: [
                                                        ...
                                                        ListView.builder(
                                                          ...
                                                          itemBuilder:
                                                              (context, index) {
                                                            bool isSelected = businessController
                                                                        .paymentIndex ==
                                                                    1 &&
                                                                Get.find<SplashController>()
                                                                        .configModel!
                                                              ...
                                                              child: InkWell(
                                                                onTap: () {
                                                                  businessController
                                                                      .setPaymentIndex(
                                                                          1);
                                                                  businessController.changeDigitalPaymentName(Get
                                                                          .find<
                                                                              SplashController>()
                                                                      .configModel!
                                                                      .activePaymentMethodList![

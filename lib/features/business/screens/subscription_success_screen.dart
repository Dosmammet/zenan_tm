...
class _SubscriptionSuccessScreenState extends State<SubscriptionSuccessScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: isDesktop
          ? CustomAppBarWidget(title: 'restaurant_registration'.tr)
          : null,
                ...
                child: Column(
                    ...
                    children: [
                      ...
                      CustomAssetImageWidget(
                        /*isVisible ?*/ widget.success
                            ? Images.checkGif
                            : Images
                                .cancelGif /*  : widget.success ? Images.check : Images.cancel*/,
                        ...
                        text: 'visit_here'.tr, style: robotoMedium.copyWith(color: Theme.of(context).primaryColor, decoration: TextDecoration.underline),
                            ...
                            : Column(
                                ...
                                children: [
                                    ...
                                    TextButton(
                                      onPressed: () => Get.offAllNamed(
                                          RouteHelper.getBusinessPlanRoute(
                                              widget.restaurantId)),
                                      child: Text(
                                        'try_again'.tr,
                                        style: robotoMedium.copyWith(

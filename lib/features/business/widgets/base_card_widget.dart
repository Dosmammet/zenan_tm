      ...
      child: Stack(clipBehavior: Clip.none, children: [
        Container(
          decoration: BoxDecoration(
            ...
            color: businessController.businessIndex == index
                ? Theme.of(context).primaryColor.withOpacity(0.1)
                : Theme.of(context).cardColor,
            border: businessController.businessIndex == index
                ? Border.all(color: Theme.of(context).primaryColor, width: 0.5)
                : null,
            boxShadow: businessController.businessIndex == index
                ? null
                : [
                    BoxShadow(
          ...
          child: Center(
              child: Text(title,
                  style: robotoMedium.copyWith(
                    ...
                    fontWeight: businessController.businessIndex == index
                        ? FontWeight.w600
                        : FontWeight.w400,
                  ))),
        ),
        businessController.businessIndex == index
            ? Positioned(
                top: -10,
                right: -10,
                child: Container(

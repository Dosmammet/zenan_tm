...
class PopularStoreWidget1 extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<RestaurantController>(builder: (restaurantController) {
      List<Restaurant>? restaurant = isPopular
                ...
                SizedBox(
                  ...
                  child: restaurant != null
                      ? ListView.builder(
                          ...
                          itemCount:
                              restaurant.length > 10 ? 10 : restaurant.length,
                                        ...
                                        Stack(children: [
                                          ClipRRect(
                                            ...
                                            child: CustomImageWidget(
                                              image:
                                                  '${restaurant[index].coverPhotoFullUrl}',
                                              height: 90,
                                              width: 200,
                                              fit: BoxFit.cover,
                                              isRestaurant: true,
                                          ...
                                          DiscountTagWidget(
                                            discount: restaurantController
                                                .getDiscount(restaurant[index]),
                                            discountType: restaurantController
                                                .getDiscountType(
                                                    restaurant[index]),
                                            freeDelivery:
                                                restaurant[index].freeDelivery,
                                          ),
                                          restaurantController
                                                  .isOpenNow(restaurant[index])
                                              ? const SizedBox()

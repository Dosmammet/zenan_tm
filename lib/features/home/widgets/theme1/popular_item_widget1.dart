...
import 'package:zenan/helper/product_helper.dart';
...
import 'package:zenan/common/widgets/not_available_widget.dart';
import 'package:zenan/common/widgets/product_bottom_sheet_widget.dart';
import 'package:zenan/common/widgets/title_widget.dart';
                                          ...
                                          Stack(children: [
                                            ClipRRect(
                                              ...
                                              child: CustomImageWidget(
                                                image:
                                                    '${productList[index].imageFullUrl}',
                                                height: 80,
                                                width: 80,
                                                fit: BoxFit.cover,
                                                isFood: true,
                                            ...
                                            DiscountTagWidget(
                                              discount:
                                                  ProductHelper.getDiscount(
                                                      productList[index]),
                                              discountType:
                                                  ProductHelper.getDiscountType(
                                                      productList[index]),
                                            ),
                                            ProductHelper.isAvailable(
                                                    productList[index])
                                                ? const SizedBox()

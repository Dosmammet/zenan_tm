        ...
        children: [
                                        ...
                                        ? InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CustomImageWidget(
                                                image:
                                                    '${homeController.bannerImageList![index1]}',
                                                fit: BoxFit.cover,
                                                height: 220,
                                              ),
                                            ),
                                    ...
                                    child: hasSecond
                                        ? InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CustomImageWidget(
                                                image:
                                                    '${homeController.bannerImageList![index2]}',
                                                fit: BoxFit.cover,
                                                height: 220,
                                              ),
                                            ),
                                    ...
                                    child: hasThird
                                        ? InkWell(
                                            ...
                                            child: ClipRRect(
                                              ...
                                              child: CustomImageWidget(
                                                image:
                                                    '${homeController.bannerImageList![index3]}',
                                                fit: BoxFit.cover,
                                                height: 220,
                                              ),
                                            ),
          ...
          homeController.bannerImageList != null
              ? Builder(builder: (context) {
                  ...
                  for (int i = 0;
                      i < homeController.bannerImageList!.length;
                      i++) {
                    if (i % 3 == 0) {
                      ...
                      return Padding(
                        ...
                        child: index == homeController.currentIndex
                            ? Container(
                                ...
                                child: Text('$endBannerIndex/$totalBanner',

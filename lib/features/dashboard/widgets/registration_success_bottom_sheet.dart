...
class RegistrationSuccessBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    bool isRestaurantRegistration =
        Get.find<DashboardController>().getIsRestaurantRegistrationSharedPref();
    return SafeArea(
      child: Container(
        ...
        child: Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Flexible(
            child: SingleChildScrollView(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, children: [
                CustomAssetImageWidget(isRestaurantRegistration
                    ? Images.restaurantRegistrationSuccess
                    : Images.dmRegistrationSuccess),

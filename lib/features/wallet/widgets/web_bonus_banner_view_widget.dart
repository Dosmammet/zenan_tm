    ...
    return GetBuilder<WalletController>(builder: (walletController) {
      return walletController.fundBonusList != null
          ? walletController.fundBonusList!.isNotEmpty
              ? Container(
                  width: 1210,
                  height: ResponsiveHelper.isDesktop(context) ? 140 : 130,
                  padding: const EdgeInsets.symmetric(
                      horizontal: 0, vertical: Dimensions.paddingSizeSmall),
                    ...
                    children: [
                      Padding(
                        ...
                        child: PageView.builder(
                          ...
                          itemCount:
                              (walletController.fundBonusList!.length / 2)
                                  .ceil(),
                          itemBuilder: (context, index) {
                            int index1 = index * 2;
                            int index2 = (index * 2) + 1;
                            bool hasSecond =
                                index2 < walletController.fundBonusList!.length;

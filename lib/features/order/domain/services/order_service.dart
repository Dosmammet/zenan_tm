...
import 'package:zenan/features/cart/domain/models/cart_model.dart' as cart;
...
import 'package:zenan/features/order/domain/models/order_details_model.dart';
...
import 'package:zenan/features/order/domain/models/subscription_schedule_model.dart';
...
class OrderService implements OrderServiceInterface {
  ...
  Future<PaginatedOrderModel?> getRunningOrderList(
      int offset, String? guestId, int limit) async {
    return await orderRepositoryInterface.getList(
        offset: offset, guestId: guestId, isRunningOrder: true, limit: limit);
  }
        ...
        if (selectedVariations[i].contains(true)) {
          ...
          for (int j = 0;
            ...
            if (selectedVariations[i][j]!) {
              ...
              optionIds
                  .add(currentFood.variations![i].variationValues![j].optionId);
            }
          }
        }
      }

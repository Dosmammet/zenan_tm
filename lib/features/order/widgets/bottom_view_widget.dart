...
import 'package:zenan/features/order/widgets/cancellation_dialogue.dart';
import 'package:zenan/features/order/widgets/subscription_pause_dialog.dart';
                    ...
                    ? Row(
                        children: [
                          (!subscription &&
                              ...
                              : const SizedBox(),
                          SizedBox(
                              width: cancelled || order.orderStatus == 'failed'
                                  ? 0
                                  : Dimensions.paddingSizeSmall),
                          !subscription &&
                                  Get.find<SplashController>()

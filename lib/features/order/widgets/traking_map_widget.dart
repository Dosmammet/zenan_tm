  ...
  void setMarker(Restaurant? restaurant, DeliveryMan? deliveryMan,
    ...
    try {
      Uint8List restaurantImageData =
          await convertAssetToUnit8List(Images.restaurantMarker, width: 120);
      Uint8List deliveryBoyImageData =
          await convertAssetToUnit8List(Images.deliveryManMarker, width: 120);
      Uint8List destinationImageData =
          await convertAssetToUnit8List(Images.myLocationMarker, width: 120);
      ...
      _controller!.moveCamera(CameraUpdate.newCameraPosition(CameraPosition(
          target: centerBounds, zoom: GetPlatform.isWeb ? 10 : 15)));

  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Text(widget.isDeliveryLog ? 'delivery_log'.tr : 'pause_log'.tr,
            style: robotoBold),
        const SizedBox(height: Dimensions.paddingSizeDefault),
        Flexible(
          child: GetBuilder<OrderController>(builder: (orderController) {
            bool notNull = widget.isDeliveryLog
                ? orderController.deliveryLogs != null
                : orderController.pauseLogs != null;
            int? length;
            if (notNull) {
              length = widget.isDeliveryLog
                ...
                ? length! > 0
                    ? ListView.builder(
                        ...
                        itemBuilder: (context, index) {
                          DeliveryLogModel? logData = widget.isDeliveryLog
                              ? orderController.deliveryLogs!.data![index]
                              : null;
                                ...
                                child: Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    borderRadius: BorderRadius.circular(
                                        Dimensions.radiusDefault),
                                    boxShadow: widget.isDeliveryLog
                                        ? [
                                            BoxShadow(
                                                color: Colors.grey
                                                    .withOpacity(0.1),
                                  ...
                                  child: widget.isDeliveryLog
                                      ? Column(children: [
                                          Row(
                                              ...
                                              children: [
                                                Text(
                                                    '${'order_id'.tr} #${orderController.deliveryLogs!.data![index].orderId}',
                                      ...
                                      : Row(
                                          ...
                                          children: [
                                              Text(
                                                  '${'subscription_id'.tr} #${orderController.pauseLogs!.data![index].subscriptionId}',
                                                  style: robotoBold),
                                              Text(

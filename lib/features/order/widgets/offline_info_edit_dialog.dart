...
class _OfflineInfoEditDialogState extends State<OfflineInfoEditDialog> {
  ...
  void initState() {
    ...
    for (int i = 0; i < widget.offlinePayment.input!.length; i++) {
      Get.find<CheckoutController>().informationControllerList.add(
          TextEditingController(
              text: widget.offlinePayment.input![i].userData));
          ...
          child: GetBuilder<CheckoutController>(builder: (checkoutController) {
            return SingleChildScrollView(
              child: Column(children: [
                ...
                ListView.builder(
                  itemCount:
                      checkoutController.informationControllerList.length,
                  shrinkWrap: true,
                  ...
                  itemBuilder: (context, i) {
                    return Padding(
                      ...
                      child: CustomTextFieldWidget(
                        hintText: widget.offlinePayment.input![i].userInput
                            .toString()
                            .replaceAll('_', ' '),
                        labelText: widget.offlinePayment.input![i].userInput
                            .toString()
                            .replaceAll('_', ' '),
                        controller:
                            checkoutController.informationControllerList[i],
                        focusNode: checkoutController.informationFocusList[i],
                        nextFocus: i !=
                                checkoutController
                                        .informationControllerList.length -
                                    1
                            ? checkoutController.informationFocusList[i + 1]
                            : null,
                        inputAction: i !=
                                checkoutController
                                        .informationControllerList.length -
                      ...
                      for (int i = 0;
                        ...
                        if (checkoutController
                          ...
                          Map<String, String> data = {
                            ...
                            "method_id":
                                widget.offlinePayment.data!.methodId.toString(),
                          };
                          ...
                          for (int i = 0;
                              ...
                              i++) {
                            data.addAll({
                              widget.offlinePayment.input![i].userInput
                                      .toString():
                                  checkoutController
                          ...
                          checkoutController
                            ...
                            if (success) {
                              Get.find<OrderController>()
                                  .timerTrackOrder(widget.orderId.toString(),

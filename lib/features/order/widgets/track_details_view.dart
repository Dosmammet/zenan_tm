...
import 'package:zenan/features/order/widgets/address_details_widget.dart';
                    ...
                    children: [
                      ...
                      Row(children: [
                        ClipOval(
                          ...
                          image:
                              '${takeAway ? track.restaurant != null ? track.restaurant!.logoFullUrl : '' : track.deliveryMan!.imageFullUrl}',
                          height: 45,
                          width: 45,
                          fit: BoxFit.cover,
                        )),

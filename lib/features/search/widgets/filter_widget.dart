...
import 'package:zenan/features/search/controllers/search_controller.dart'
    as search;
import 'package:zenan/features/search/widgets/custom_check_box_widget.dart';
  ...
  Widget build(BuildContext context) {
    return Container(
      ...
      constraints: BoxConstraints(
          maxHeight: context.height * 0.9, minHeight: context.height * 0.6),
      ...
      child: GetBuilder<search.SearchController>(builder: (searchController) {
        ...
        List<DropdownItem<int>> priceSortList = _generateDropDownPriceSortList(
                          ...
                          Expanded(
                            child: Container(
                              ...
                              child: CustomDropdown<int>(
                                ...
                                child: Text(
                                  !isRestaurant
                                      ? searchController.priceSortIndex == -1
                                          ? 'select_price_sort'.tr
                                          : searchController.priceSortList[
                                              searchController.priceSortIndex]
                                      : searchController
                                                  .restaurantPriceSortIndex ==
                                              -1
                                          ? 'select_price_sort'.tr
                          ...
                          Expanded(
                            child: Container(
                              decoration: BoxDecoration(
                                ...
                                color: Theme.of(context).cardColor,
                                border: Border.all(
                                    color: searchController.sortIndex == -1 ||
                                            (isRestaurant &&
                                                searchController
                                                        .restaurantSortIndex ==
                                                    -1)
                              ...
                              child: CustomDropdown<int>(
                                ...
                                child: Text(
                                  !isRestaurant
                                      ? searchController.sortIndex == -1
                                          ? 'select_letter_sort'.tr
                                          : searchController.sortList[
                                              searchController.sortIndex]
                                      : searchController.restaurantSortIndex ==
                                              -1
                                          ? 'select_letter_sort'.tr
                                          : searchController.sortList[
                                              searchController

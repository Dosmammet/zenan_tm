...
import 'package:zenan/common/widgets/search_field_widget.dart';
...
import 'package:zenan/features/home/widgets/cuisine_card_widget.dart';
import 'package:zenan/features/search/controllers/search_controller.dart'
    as search;
import 'package:zenan/features/search/widgets/filter_widget.dart';
import 'package:zenan/features/search/widgets/search_result_widget.dart';
...
class SearchScreen extends StatefulWidget {
  bool isHomePage;
  SearchScreen({super.key, required this.isHomePage});
...
class SearchScreenState extends State<SearchScreen> {
  ...
  void _actionOnBackButtonSearch() {
    if (!Get.find<search.SearchController>().isSearchMode) {
      Get.find<search.SearchController>().setSearchMode(true);
      _searchTextEditingController.text = '';
      _showSuggestion = false;

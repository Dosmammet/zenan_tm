...
class GuestLoginWidget extends StatefulWidget {
  ...
  const GuestLoginWidget(
      {super.key, required this.loginTooltipController, this.onTap});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
        Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
          ...
          SizedBox(
            ...
            child: TextButton(
              ...
              child: Text('click_here_to_login'.tr,
        ...
        CustomToolTip(
          message:
              'login_to_manage_your_orders_and_enjoy_additional_benefits'.tr,

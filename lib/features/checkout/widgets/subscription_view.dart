...
class SubscriptionView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
            ...
            Container(
              ...
              child: CustomDropdown<int>(
                onChange: (int? value, int index) {
                  checkoutController.setSubscriptionType(
                ...
                child:
                    Text(typeList[checkoutController.subscriptionTypeIndex].tr),
              ),
            ),
          ]),
        ),
                ...
                child: Column(
                    ...
                    CustomDatePicker(
                      ...
                      onDatePicked: (DateTimeRange range) =>
                          checkoutController.setSubscriptionRange(range),
                    ),
                  ]))
            : const SizedBox(),
      ]),
          ...
          : Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
              ...
              InkWell(
                ...
                child: Container(
                  ...
                  child: Text(
                    checkoutController.selectedDays[0] != null
                        ? DateConverter.dateToTimeOnly(
                            checkoutController.selectedDays[0]!)
                        : 'choose_time'.tr,
                    style: robotoRegular,
                  ),
                ),
      ...
      SizedBox(
          height: checkoutController.subscriptionType != 'daily'
      ...
      checkoutController.subscriptionType != 'daily'
          ? SizedBox(
              child: GridView.builder(
                  ...
                  shrinkWrap: true,
                  itemCount: checkoutController.subscriptionType == 'weekly'
                      ? 7
                  ...
                  itemBuilder: (context, index) {
                    bool isSelected =
                        checkoutController.selectedDays[index] != null;
                        ...
                        child: Column(
                            ...
                            children: [
                              Text(
                                checkoutController.subscriptionType == 'monthly'
                                    ? '${'day'.tr} : ${index + 1}'
                                    : checkoutController.subscriptionType ==
                                            'weekly'
                                        ? weekDays[index].tr
                                        : '',
                                maxLines: 1,

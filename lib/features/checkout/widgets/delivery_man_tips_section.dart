...
import 'package:zenan/features/checkout/widgets/tips_widget.dart';
                ...
                child: Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        (widget.checkoutController.selectedTips ==
                            ...
                            : SizedBox(
                                ...
                                child: ListTile(
                                  ...
                                  trailing: Checkbox(
                                    ...
                                    value:
                                        widget.checkoutController.isDmTipSave,
                                    onChanged: (bool? isChecked) => widget
                                        .checkoutController
                                        .toggleDmTipSave(),
                                  ),
                      ...
                      SizedBox(
                        height: (widget.checkoutController.selectedTips ==
                            ...
                            ? 0
                            : 60,
                        child: (widget.checkoutController.selectedTips ==
                                    AppConstants.tips.length - 1) &&
                                widget.checkoutController.canShowTipsField
                            ? const SizedBox()
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return TipsWidget(
                                    ...
                                    onTap: () {
                                      total = total -
                                          widget.checkoutController.tips;
                                      widget.checkoutController
                                          .updateTips(index);
                                      if (widget.checkoutController
                                              .selectedTips !=
                                          AppConstants.tips.length - 1) {
                                        widget.checkoutController.addTips(
                                            double.parse(
                                                AppConstants.tips[index]));
                                      }
                                      if (widget.checkoutController
                                      ...
                                      widget.checkoutController.tipController
                                              .text =
                                          widget.checkoutController.tips
                                              .toString();
                                      if (widget.checkoutController
                                      ...
                                      try {
                                        if (double.parse(value) >= 0) {
                                          if (Get.find<AuthController>()
                                            ...
                                            total = total -
                                                widget.checkoutController.tips;
                                            await widget.checkoutController

...
class OrderSuccessfulDialogWidget extends StatefulWidget {
  ...
  @override
  State<OrderSuccessfulDialogWidget> createState() =>
      _OrderSuccessfulDialogWidgetState();
}

class _OrderSuccessfulDialogWidgetState
    extends State<OrderSuccessfulDialogWidget> {
  @override
  void initState() {
    super.initState();
    Get.find<OrderController>().trackOrder(
        widget.orderID.toString(), null, false,
        ...
        child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          if (orderController.trackModel != null) {
            ZoneData zoneData = AddressHelper.getAddressFromSharedPref()!
                ...
                .firstWhere((data) =>
                    data.id ==
                    AddressHelper.getAddressFromSharedPref()!.zoneId);

...
import 'package:zenan/features/checkout/widgets/payment_failed_dialog.dart';
...
import 'package:zenan/features/wallet/widgets/fund_payment_dialog_widget.dart';
...
class PaymentScreenState extends State<PaymentWebViewScreen> {
  ...
  void _redirect(String url, String? contactNumber) {
    if (_canRedirect) {
      bool isSuccess =
          url.contains('success') && url.startsWith(AppConstants.baseUrl);
      bool isFailed =
          url.contains('fail') && url.startsWith(AppConstants.baseUrl);
      bool isCancel =
          url.contains('cancel') && url.startsWith(AppConstants.baseUrl);

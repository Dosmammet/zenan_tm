...
class _WalletBottomSheetState extends State<LoyaltyBottomSheetWidget> {
  ...
  int? exchangePointRate =
      Get.find<SplashController>().configModel!.loyaltyPointExchangeRate ?? 0;
  int? minimumExchangePoint =
      Get.find<SplashController>().configModel!.minimumPointToTransfer ?? 0;
              ...
              Form(
                ...
                child: SizedBox(
                  ...
                  child: CustomTextFieldWidget(
                    ...
                    required: true,
                    validator: (value) => ValidateCheck.loyaltyCheck(
                        value,
                        minimumExchangePoint,
                ...
                return CustomButtonWidget(
                  ...
                  onPressed: () {
                    if (_amountFormKey!.currentState!.validate()) {
                      ...
                      int? point = Get.find<ProfileController>()
                          .userInfoModel!
                          .loyaltyPoint;

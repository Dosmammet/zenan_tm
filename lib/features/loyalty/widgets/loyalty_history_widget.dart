...
import 'package:zenan/features/loyalty/widgets/loyalty_history_card_widget.dart';
            ...
            ? walletController.transactionList!.isNotEmpty
                ? GridView.builder(
                    ...
                    padding: EdgeInsets.only(
                        ...
                        bottom: ResponsiveHelper.isDesktop(context) ? 0 : 50),
                    itemBuilder: (context, index) {
                      return LoyaltyHistoryCardWidget(
                          index: index, data: walletController.transactionList);
                    },
                  )
                : NoDataScreen(
                    title: 'no_transaction_yet'.tr, isEmptyTransaction: true)
            : LoyaltyShimmer(loyaltyController: walletController),

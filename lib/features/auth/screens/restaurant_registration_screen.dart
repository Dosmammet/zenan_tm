...
import 'package:zenan/common/widgets/confirmation_dialog_widget.dart';
import 'package:zenan/common/widgets/custom_tool_tip.dart';
import 'package:zenan/common/widgets/validate_check.dart';
import 'package:zenan/features/auth/domain/models/restaurant_body_model.dart';
import 'package:zenan/features/auth/domain/models/translation_body_model.dart';
import 'package:zenan/features/auth/widgets/cuisine_widget.dart';
...
import 'package:zenan/features/auth/widgets/custom_time_picker_widget.dart';
import 'package:zenan/features/auth/widgets/pass_view_widget.dart';
import 'package:zenan/features/auth/widgets/registration_stepper_widget.dart';
import 'package:zenan/features/auth/widgets/restaurant_additional_data_section_widget.dart';
import 'package:zenan/features/auth/widgets/select_location_view_widget.dart';
...
import 'package:zenan/common/widgets/web_page_title_widget.dart';
                                                                ...
                                                                children: [
                                                                  Padding(
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      child: restaurantRegController.pickedLogo !=
                                                                              null
                                                                          ? GetPlatform.isWeb
                                                                              ? Image.network(
                                                                  ...
                                                                  Positioned(
                                                                    ...
                                                                    child:
                                                                        InkWell(
                                                                      onTap: () => restaurantRegController.pickImage(
                                                                          true,
                                                                          false),
                                                                      child:
                                                                          DottedBorder(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          child:
                                                                              Visibility(
                                                                            visible:
                                                                                restaurantRegController.pickedLogo != null,
                                                                            child:
                                                                                Container(
                                                              ...
                                                              child:
                                                                ...
                                                                child: Center(
                                                                  child:
                                                                      Visibility(
                                                                    visible:
                                                                        restaurantRegController.pickedCover !=
                                                                            null,
                                                                    child:
                                                                        Container(
                                                                      padding: const EdgeInsets
                                      ...
                                      child: Column(
                                          ...
                                          children: [
                                            ...
                                            restaurantRegController
                                                ...
                                                : const SizedBox(),
                                            SizedBox(
                                                height: restaurantRegController
                                                        .dataList!.isNotEmpty
                                                    ? Dimensions
                                                        .paddingSizeLarge
                                                    : 0),
                  ...
                  child: Column(children: [
                    ...
                    CustomTextFieldWidget(
                      ...
                      validator: (value) => ValidateCheck.validateEmptyText(
                          value, "restaurant_name_field_is_required".tr),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraLarge),
                    CustomTextFieldWidget(
                      ...
                      validator: (value) => ValidateCheck.validateEmptyText(
                          value, "restaurant_address_field_is_required".tr),
                    ),
                    const SizedBox(height: Dimensions.paddingSizeExtraLarge),
                    CuisineWidget(
                        cuisineTextController: _cuisineController,
              ...
              Row(crossAxisAlignment: CrossAxisAlignment.start, children: [
                Expanded(
                  ...
                  CustomTextFieldWidget(
                    ...
                    required: true,
                    validator: (value) => ValidateCheck.validateEmptyText(
                        value, "restaurant_vat_tax_field_is_required".tr),
                  ),
                ...
                : () {
                    ...
                    if (restaurantRegiController.storeStatus == 0.1 &&
                      ...
                      if (_formKeyLogin!.currentState!.validate()) {
                        ...
                        } else if (restaurantRegiController.selectedZoneIndex ==
                            -1) {
                          showCustomSnackBar(
                      ...
                      if (_formKeySecond!.currentState!.validate()) {
                        if (fName.isEmpty) {
                          ...
                          for (var index in Get.find<CuisineController>()
                              .selectedCuisines!) {

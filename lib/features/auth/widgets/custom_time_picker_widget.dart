...
import 'package:zenan/features/auth/widgets/min_max_time_picker_widget.dart';
                  ...
                  Row(
                      ...
                      children: [
                        MinMaxTimePickerWidget(
                          times: time,
                          onChanged: (int index) => restaurantRegiController
                              .minTimeChange(time[index]),
                          initialPosition: 10,
                        ),
                        ...
                        MinMaxTimePickerWidget(
                          times: time,
                          onChanged: (int index) => restaurantRegiController
                              .maxTimeChange(time[index]),
                          initialPosition: 10,
                        ),
                        MinMaxTimePickerWidget(
                          times: unit,
                          onChanged: (int index) => restaurantRegiController
                              .timeUnitChange(unit[index]),
                          initialPosition: 1,
                        ),
                      ]),
                  Padding(

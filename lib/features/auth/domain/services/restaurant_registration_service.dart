...
class RestaurantRegistrationService
  ...
  Future<Response> registerRestaurant(Map<String, String> data, XFile? logo,
    ...
    Response response = await restaurantRegistrationRepoInterface
        .registerRestaurant(data, logo, cover, additionalDocument);
  ...
  Future<bool> checkInZone(String? lat, String? lng, int zoneId) async {
    return await restaurantRegistrationRepoInterface.checkInZone(
        lat, lng, zoneId);
  }
}

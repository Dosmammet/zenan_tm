    ...
    return Container(
      ...
      child: GetBuilder<AuthController>(builder: (authController) {
        return Column(mainAxisSize: MainAxisSize.min, children: [
          ...
          Padding(
            ...
            child: Text(
              authController.notification
                  ? 'if_you_disable_this_option_you_will_not_receive_system_notifications'
                      .tr
                  : 'when_you_enable_this_option_you_will_be_notified_with_the_system_notifications'
                      .tr,
          ...
          Row(children: [
            Expanded(
              child: !authController.notificationLoading
                  ? CustomButtonWidget(
                      onPressed: () async {

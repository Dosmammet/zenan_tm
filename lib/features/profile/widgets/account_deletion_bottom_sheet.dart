...
class AccountDeletionBottomSheet extends StatelessWidget {
  ...
  const AccountDeletionBottomSheet(
      {super.key,
      required this.profileController,
      this.isRunningOrderAvailable = false});
      ...
      child: Column(mainAxisSize: MainAxisSize.min, children: [
        ...
        Padding(
          padding: EdgeInsets.only(
              left: isRunningOrderAvailable ? 70 : 50,
              right: isRunningOrderAvailable ? 70 : 50,
              bottom: 20),
          child: isRunningOrderAvailable
              ? CustomButtonWidget(

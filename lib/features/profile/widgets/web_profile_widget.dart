...
import 'package:zenan/features/profile/widgets/account_deletion_bottom_sheet.dart';
import 'package:zenan/features/profile/widgets/notification_status_change_bottom_sheet.dart';
import 'package:zenan/features/profile/widgets/profile_button_widget.dart';
import 'package:zenan/features/profile/widgets/profile_card_widget.dart';
                ...
                child: Column(
                    ...
                    children: [
                      ClipOval(
                        ...
                        fit: BoxFit.cover,
                        imageColor:
                            isLoggedIn ? Theme.of(context).hintColor : null,
                      )),
            ...
            isLoggedIn
                ? Expanded(
                    child: ProfileCardWidget(
                      ...
                      data: profileController.userInfoModel!.orderCount
                          .toString(),
                      ...
                      return ProfileButtonWidget(
                        ...
                        onTap: () {
                          Get.dialog(const Dialog(
                              child: NotificationStatusChangeBottomSheet()));
                        },
                      );
                    })
                  : const SizedBox(),

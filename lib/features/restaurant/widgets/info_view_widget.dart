        ...
        children: [
                    ...
                    child: ClipRRect(
                      ...
                      child: Stack(children: [
                        CustomImageWidget(
                          ...
                          width: 60 - (scrollingRate * 15),
                          fit: BoxFit.cover,
                        ),
                        restController.isRestaurantOpenNow(
                                restaurant.active!, restaurant.schedules)
                            ? const SizedBox()
                            : Positioned(
                                left: 0,
                                right: 0,
                ...
                child: Column(
                  ...
                  Text(
                    ...
                    style: robotoMedium.copyWith(
                        fontSize:
                            Dimensions.fontSizeLarge - (scrollingRate * 3),
                  ...
                  Text(
                    ...
                    style: robotoRegular.copyWith(
                        fontSize:
                            Dimensions.fontSizeSmall - (scrollingRate * 2),
          ...
          SizedBox(
              height: Dimensions.paddingSizeLarge -
                  (scrollingRate *
                      (isDesktop ? 2 : Dimensions.paddingSizeLarge))),
          Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
            const Expanded(child: SizedBox()),
            Column(children: [
              Icon(Icons.access_time,
                  color: Theme.of(context).primaryColor,
                  size: 20 - (scrollingRate * (isDesktop ? 2 : 20))),
            ...
            InkWell(
              ...
              child: Column(children: [
                Image.asset(Images.restaurantLocationIcon,
                    height: 20 - (scrollingRate * (isDesktop ? 2 : 20)),
                    width: 20 - (scrollingRate * (isDesktop ? 2 : 20)),
                    color: Theme.of(context).primaryColor),
                const SizedBox(width: Dimensions.paddingSizeExtraSmall),
                Text('location'.tr,
                    style: robotoRegular.copyWith(

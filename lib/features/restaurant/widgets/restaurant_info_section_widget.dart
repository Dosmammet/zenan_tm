...
import 'package:zenan/features/restaurant/widgets/coupon_view_widget.dart';
import 'package:zenan/common/widgets/customizable_space_bar_widget.dart';
import 'package:zenan/features/restaurant/widgets/info_view_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return SliverAppBar(
      ...
      flexibleSpace: GetBuilder<CouponController>(builder: (couponController) {
        bool hasCoupons = couponController.couponList != null &&
            ...
            title: CustomizableSpaceBarWidget(
              builder: (context, scrollingRate) {
                return !isDesktop
                    ...
                    //     child: Container(
                    //       height:
                    //           (hasCoupon ? 260 : 160) - (scrollingRate * 25),
                    //       decoration: BoxDecoration(
                    ...
                    : Align(
                        ...
                        child: Container(
                          ...
                          margin: EdgeInsets.symmetric(
                              horizontal: hasCoupons
                                  ? Dimensions.paddingSizeDefault
                                  : 200,
                              vertical: Dimensions.paddingSizeSmall),
                          child: Column(
                            children: [
                              restaurant.announcementActive != null &&

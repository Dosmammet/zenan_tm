...
import 'package:zenan/features/location/domain/models/prediction_model.dart';
    ...
    if (_updateAddressData) {
      ...
      if (fromAddress) {
        ...
        _pickPosition = Position(
          latitude: position == null ? 0 : position.target.latitude,
          longitude: position == null ? 0 : position.target.longitude,
          timestamp: DateTime.now(),
          heading: 1,
          accuracy: 1,
          altitude: 1,
      ...
      ZoneResponseModel responseModel = await getZone(
          position == null ? '0' : position.target.latitude.toString(),
          position == null ? '0' : position.target.longitude.toString(),
          true);
      _buttonDisabled = !responseModel.isSuccess;
      if (_changeAddress) {
        String addressFromGeocode = await getAddressFromGeocode(

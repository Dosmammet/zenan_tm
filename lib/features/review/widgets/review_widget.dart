...
import 'package:zenan/common/widgets/readmore_widget.dart';
            ...
            Expanded(
              child: Column(
                  ...
                  children: [
                    ...
                    isDesktop
                        ? Text(
                            DateConverter.stringDateTimeToDate(
                                review.createdAt!),
                    ...
                    SizedBox(
                        height:
                            isDesktop ? Dimensions.paddingSizeExtraSmall : 0),
                    isDesktop
                        ? ReadMoreText(
                            review.comment ?? '',
                            style: robotoRegular.copyWith(
                ...
                ? InkWell(
                    onTap: () async {
                      Product? product = await Get.find<ProductController>()
                          .getProductDetails(review.foodId!, null);
                      if (product != null) {
                        Get.dialog(Dialog(
                            child: ProductBottomSheetWidget(
                                product: product, fromReview: true)));
                      } else {

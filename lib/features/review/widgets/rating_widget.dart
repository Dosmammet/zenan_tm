...
import 'package:zenan/features/review/widgets/rating_progress_widget.dart';
import 'package:zenan/features/review/widgets/total_rating_review_view_widget.dart';
...
class RatingWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    List<double>? percentages = ratings?.map((rating) {
      return (rating / ratings!.reduce((value, element) => value + element)) *
          100;
    }).toList();
    ...
    return Container(
      ...
      child: ResponsiveHelper.isDesktop(context)
          ? Column(children: [
              ...
              RatingBarWidget(
                  rating: averageRating, ratingCount: null, size: 20),
              const SizedBox(height: Dimensions.paddingSizeDefault),
              Row(children: [
                TotalRatingReviewViewWidget(
                    totalNumber: ratingCount ?? 0, isRating: true),
                TotalRatingReviewViewWidget(
                    totalNumber: reviewCommentCount ?? 0, isRating: false),
              ]),

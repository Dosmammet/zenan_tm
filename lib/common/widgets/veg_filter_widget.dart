...
class VegFilterWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    List<PopupMenuEntry> entryList = _generateProductTypeList(
        Get.find<ProductController>().productTypeList, context);
    ...
    return Get.find<SplashController>().configModel!.toggleVegNonVeg!
        ? Padding(
            ...
            child: PopupMenuButton<dynamic>(
              ...
              onSelected: (dynamic value) => onSelected!(
                  Get.find<ProductController>().productTypeList[value]),
  ...
  List<PopupMenuEntry> _generateProductTypeList(
      List<String> productTypeList, BuildContext context) {

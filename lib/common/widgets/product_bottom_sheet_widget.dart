...
import 'package:zenan/common/widgets/discount_tag_widget.dart';
import 'package:zenan/common/widgets/discount_tag_without_image_widget.dart';
import 'package:zenan/common/widgets/product_bottom_sheet_shimmer.dart';
import 'package:zenan/common/widgets/quantity_button_widget.dart';
import 'package:zenan/common/widgets/rating_bar_widget.dart';
...
import 'package:zenan/helper/cart_helper.dart';
                            ...
                            Padding(
                              ...
                              child: Column(
                                  ...
                                  children: [
                                    ...
                                    SizedBox(
                                        height: (product!.variations != null &&
                                                              ...
                                                              Flexible(
                                                                child: Text(
                                                                  ...
                                                                  overflow:
                                                                      TextOverflow
                                                                          .ellipsis,
                                                                  style: product!.addOns![index].stockType != 'unlimited' &&
                                                                          product!.addOns![index].addonStock !=
                                                                              null &&
                                                                          product!.addOns![index].addonStock! <=
                                                                              0
                                                                        ...
                                                                        onTap:
                                                                          ...
                                                                          if (productController.addOnQtyList[index]! >
                                                                            ...
                                                                            productController.setAddOnQuantity(
                                                                                false,
                                                                                index,
                                                                                product!.addOns![index].stockType,
                                                                                product!.addOns![index].addonStock);
                                                                          } else {
                                                                            productController.addAddOn(
                                                                                false,

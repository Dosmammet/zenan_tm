...
class ProductViewWidgetPinterest extends StatefulWidget {
  final List<Product?>? products;
  final List<Restaurant?>? restaurants;
  final bool isRestaurant;
  final EdgeInsetsGeometry padding;
  ...
  @override
  State<ProductViewWidgetPinterest> createState() =>
      _ProductViewWidgetPinterestState();
}

class _ProductViewWidgetPinterestState
    extends State<ProductViewWidgetPinterest> {
  final rnd = Random();
  ...
  void initState() {
    ...
    extents = List<int>.generate(1000, (int index) => rnd.nextInt(4) + 1);
    super.initState();
  }

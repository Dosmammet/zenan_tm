...
class AppConstants {
  static const String appName = 'Zenan';
  ...
  static const String webHostedUrl = 'http://zenan.info';
  static const bool useReactWebsite = false;

  // static const String baseUrl = 'https://stackfood-admin.6amtech.com';
  static const String baseUrl = 'http://zenan.info';
  ...
  /// Deep Links
  static const String yourScheme = 'Zenan';
  static const String yourHost = 'zenan.net';
  ...
  static List<LanguageModel> languages = [
    ...
    //     languageCode: 'ar'),
    LanguageModel(
        imageUrl: Images.turkmen,
        languageName: 'Turkmen',
        countryCode: 'TK',
        languageCode: 'tk'),
    LanguageModel(
        imageUrl: Images.russian,
